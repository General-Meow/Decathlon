...
setInterval(async function () {
  ...
  result.push(await checkStockForUrl("WEIGHT TRAINING DUMBBELL KIT 20 KG", weightsStockUrl));
  result.push(await checkStockForUrl("WEIGHT TRAINING DUMBBELL KIT 10 KG",
      weights10KgSetUrl));
  result.push(await checkStockForUrl("CAST IRON WEIGHT TRAINING DISC WEIGHT 28MM 1KG",
      weight1KgUrl));
  result.push(await checkStockForUrl("CAST IRON WEIGHT TRAINING DISC WEIGHT 28MM 2KG",
      weight2KgUrl));
  result.push(await checkStockForUrl("CAST IRON WEIGHT TRAINING DISC WEIGHT 28MM 5KG",
      weight5KgUrl));
  result.push(await
